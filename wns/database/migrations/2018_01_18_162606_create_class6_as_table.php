...
class CreateClass6AsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('class6_as', function (Blueprint $table) {
          $table->date('year');
